          ...
          <form className="space-y-4" onSubmit={onSubmit}>
            <div>
              ...
              <input
                ...
                className="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-navy-500 focus:border-navy-500 sm:text-sm"
